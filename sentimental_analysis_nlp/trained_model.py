...
def text_clean(dataset):
    """
    It takes review column by iterating each row and returns corpus which is a list consisting of words
    where characters except alphabets are removed in the words and also stopwords are removed.
...
def text_to_array(input_text):
    """
    It takes text from the form and returns corpus which is a list consist of words
    where characters except alphabets are removed in the words and also stopwords are removed.
